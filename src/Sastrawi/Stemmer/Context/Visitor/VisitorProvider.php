...
class VisitorProvider
{
    ...
    protected function initVisitors()
    {
        ...
        $this->prefixVisitors[] = new PrefixDisambiguator(array(new Disambiguator\DisambiguatorPrefixRule18()));
        ...
        $this->prefixVisitors[] = new PrefixDisambiguator(array(new Disambiguator\DisambiguatorPrefixRule31()));
